...
React's useRouteMatch allows you to add nested routes to your application.

1. How would you explain form validation to someone who has never programmed before?

Form validation provides helpful feedback to a user about whether or not they have filled out the form correctly. 

1. In 1-2 sentences, define end to end testing.

End to end testing is testing the entire user experience from beginning to end, making sure that users can navigate an application and accomplish things like submitting forms etc. without encountering any bugs. 
